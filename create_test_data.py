...
def generate_csv(filename, output_csv):
...
generate_csv('midi/Scarified.mid', 'data/test_data.csv')
generate_csv('midi/Scarified-p1.mid', 'data/pat_1.csv')
generate_csv('midi/Scarified-p2.mid', 'data/pat_2.csv')
generate_csv('midi/Scarified-p3.mid', 'data/pat_3.csv')
